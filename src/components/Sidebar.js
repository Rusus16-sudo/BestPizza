  ...
  return (
    <div className={styles.sidebar}>
      <div className={styles.logo}>
        <svg viewBox="0 0 24 24" width="28" height="28" className={styles.logoIcon} fill="currentColor">
      ...
      <div className={styles.promoCard}>
        <h4>-50% sur votre<br/>première commande</h4>
        <p>Code: <span className={styles.code}>MIAM50</span></p>
