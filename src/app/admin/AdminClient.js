...
export default function AdminClient({ section, initialStaff = [] }) {
  ...
  const [showPassword, setShowPassword] = useState(false)      // création d'un compte
  const [showNewPassword, setShowNewPassword] = useState(false) // réinitialisation
            ...
            <form onSubmit={handleCreateUser}>
              ...
              <div className={styles.inputGroup}>
                ...
                <div className={styles.passwordWrap}>
                  <input type={showPassword ? 'text' : 'password'} className={styles.formInput} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="8 caractères minimum" required minLength="8" />
                  <button
                    type="button"
          ...
          <div className={styles.modal}>
            ...
            <form onSubmit={handleResetPassword}>
              <div className={styles.inputGroup}>
                ...
                <div className={styles.passwordWrap}>
                  <input type={showNewPassword ? 'text' : 'password'} className={styles.formInput} value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="8 caractères minimum" required minLength="8" />
                  <button
                    type="button"
                    className={styles.eyeBtn}
